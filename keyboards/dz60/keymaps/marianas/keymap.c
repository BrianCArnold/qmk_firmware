...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY]=
    LAYOUT_marianas(
      ...
      CTLL,  WINL,  ALTL,  KC_SPC, LWIN(ESCAP), KC_SPC,  ALTR,  WINR, KC_MEH, APPR,  CTLR),
  ...
  [NAV_CLUSTER]=
    LAYOUT_marianas(
      ...
      ____,  ____,  ____,  ____, ____, KP_0,  KDOT,  KNTR,  ____,  ____,  ____),
  ...
  [GAMING]=
    LAYOUT_marianas(
      ...
      ____,  KCNO,  ____,   ____,  ____,  ____,   ____,   ____,  KCNO,  ____,  QWRTY),
  ...
  [SQLMACROS]=
    LAYOUT_marianas(
      ...
      ____,  ____,  ____,  LSFT(KC_LBRC), ____, RSFT(KC_RBRC), ____,  ____,  ____,  ____,  ____),
  ...
  [FN_LAYER]=
    LAYOUT_marianas(
      ...
      ____, ____, ____, SM_UP, ____, SM_DN, ____, ____, ____, ____, RESET)
