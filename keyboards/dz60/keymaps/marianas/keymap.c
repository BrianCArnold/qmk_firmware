...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY]=
    LAYOUT_marianas(
      ...
      MT(MOD_LCTL, KC_TAB),  KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,  KC_O,  KC_P,  LBRC,  RBRC,  BSLASH,
      ...
      CTLL,  WINL,  ALTL,  KC_SPC, MT(MOD_LWIN, LWIN(ESCAP)), KC_SPC,  ALTR,  WINR, KC_MEH, APPR,  CTLR),
  ...
  [SQLMACROS]=
    LAYOUT_60_ansi(
      S_ALTER, R_D1,  R_D2,  R_D3,  R_D4,  R_D5,  R_D6,  R_D7,  R_D8, R_D9,  R_D10, R_D12, R_D20,  ______,
