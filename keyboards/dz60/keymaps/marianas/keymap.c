...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SQLMACROS]=
    LAYOUT_60_ansi(
      S_ALTER, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,    ___________,
      ...
      ________,  RGB_VAI, RGB_VAD, S_COUNT,  ____,  ____,  S_NOT,  ____,  ____,  ____,  ____,  _________________,
      ____,  ____,  ____,  /*------------------*/_____/*------------------*/,  ____,  ____,  ____,  ____),

  [DICE]=
    LAYOUT_60_ansi(
      KCNO,   R_D1,  R_D2,  R_D3,  R_D4,  R_D5,  R_D6,  R_D7,  R_D8, R_D9,  R_D10, R_D12, R_D20,  ______,
      KCNO  ,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,   KCNO,
      _______,  KCNO,  KCNO,  R_DD,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,         KCNO,
      KCNO    ,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,  KCNO,               KCNO,
      KCNO,  KCNO,  KCNO,  /*------------------*/KCNO /*------------------*/,  KCNO,  KCNO,  KCNO,  KCNO),
  ...
  [FN_LAYER]=
    LAYOUT_60_ansi(
      ...
      ____, RGB_HUI, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_END, QWRTY, GAME, NAVS, TO(DICE), ____,
