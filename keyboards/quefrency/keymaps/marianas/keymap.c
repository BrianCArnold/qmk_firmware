...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY]=
    LAYOUT(
      ...
      CTLL,  WINL,  ALTL,  LWIN(ESCAP),KC_SPC,  KC_SPC,LWIN(ESCAP),ALTR,  WINR, KC_MEH, APPR,  CTLR),

  [NAV_CLUSTER]=
    LAYOUT(
      _____,  PSCR,  SCRL,  PAUS,  NSRT,  HOME,  PGUP,  NMLK,  KSSH,  STAR,  KMIN,  ____,  ____,  ____,  ______,
      ...
      ________,  ____,  ____,  ____,  LEFT,  D_WN,  RGHT,  KP_1,  KP_2,  KP_3,  KNTR,  _________________, ____,
      ____,  ____,  ____,  ____, ____, KP_0,  KDOT,  KNTR,  ____,  ____,  ____, ____),

  [GAMING]=
    LAYOUT(
      _____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ______,
      ...
      ________,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  ____,  _________________, ____,
      ____,  KCNO,  ____,   ____,  ____,  ____,   ____,  ____,   ____,  KCNO,  ____,  QWRTY),
  ...
  [FN_LAYER]=
    LAYOUT(
      ...
      ____, RGB_HUI, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_END, QWRTY, GAME, NAVS, ____, ____, ____,
